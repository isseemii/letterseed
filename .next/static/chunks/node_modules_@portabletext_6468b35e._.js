...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_internal$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@sanity/schema/lib/_internal.mjs [app-client] (ecmascript) <locals>");
...
function compileType(rawType) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Schema"].compile({
        ...
        types: [
            rawType,
            ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_internal$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["builtinTypes"]
        ]
    }).get(rawType.name);
}
...
function compileSchemaDefinitionToPortableTextMemberSchemaTypes(definition) {
    ...
    }), schema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Schema"].compile({
        types: [
            portableTextSchema,
            ...blockObjects,
            ...inlineObjects
    ...
    return {
        ...
        portableText: {
            ...
            of: pteSchema.portableText.of.map((schemaType)=>{
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isObjectSchemaType"])(schemaType)) return schemaType;
                const nameMapping = blockObjectNames[schemaType.name];
                schemaType.name = nameMapping ?? schemaType.name;
                for (const field of schemaType.fields)if (!(field.name !== "children" || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isArraySchemaType"])(field.type))) for (const ofSchemaType of field.type.of){
    ...
    return blocks.flatMap((block)=>{
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$schema$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTextBlock"])(context, block)) {
            ...
            if (hasBlockObjects || hasBlocks) {
                ...
                return splitChildren.length === 1 && splitChildren[0].type === "children" && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isEqual$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(splitChildren[0].children, block.children) ? [
                    block
...
function trimWhitespace(schema, blocks) {
    return blocks.forEach((block)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$schema$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTextBlock"])({
            schema
...
`
        ...
        // Deal with list items
        {
            deserialize (el, next, block) {
                ...
                if (!listItem || !el.parentNode || !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$block$2d$tools$2f$lib$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HTML_LIST_CONTAINER_TAGS"][parentTag]) return;
...
function isWordListElement(el) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$block$2d$tools$2f$lib$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isElement"])(el) && el.className ? el.className === "MsoListParagraphCxSpFirst" || el.className === "MsoListParagraphCxSpMiddle" || el.className === "MsoListParagraphCxSpLast" : !1;
}
function createWordRules() {
    return [
        {
            deserialize (el, next) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$block$2d$tools$2f$lib$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tagName"])(el) === "p" && isWordListElement(el)) return {
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$block$2d$tools$2f$lib$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_BLOCK"],
                    listItem: getListItemStyle(el),
                    level: getListItemLevel(el),
                    style: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$block$2d$tools$2f$lib$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BLOCK_DEFAULT_STYLE"],
                    children: next(el.childNodes)
                };
            }
        }
...
class HtmlDeserializer {
   ...
   */ constructor(schema, options = {}){
        ...
        this.parseHtml = (html)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$block$2d$tools$2f$lib$2f$_chunks$2d$es$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["preprocess"])(html, parseHtml, {
...
function normalizeBlock(node, options = {}) {
    ...
    return block.children = block.children.reduce((acc, child)=>{
        ...
        return previousChild && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$schema$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSpan"])({
            ...
            schema
        }, previousChild) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$isEqual$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(previousChild.marks, child.marks) ? (lastChild && lastChild === child && child.text === "" && block.children.length > 1 || (previousChild.text += child.text), acc) : (acc.push(child), acc);
    }, []).map((child)=>{
...
function applyPatchToObject(value, patch) {
    ...
    return tail.length === 0 && patch.type === "unset" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$omit$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(nextValue, head) : (!(head in nextValue) && tail.length > 0 || (nextValue[head] = applyPatch(nextValue[head], {
        ...patch,
        path: tail
    })), nextValue);
}
...
//# sourceMappingURL=node_modules_%40portabletext_6468b35e._.js.map